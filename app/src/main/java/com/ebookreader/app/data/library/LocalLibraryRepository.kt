package com.ebookreader.app.data.library
        ...
        return combine(
            ...
            progresses.mapNotNull { progressEntity ->
                ...
                val downloadedDomain = downloadedEntity?.toDomain()
                    ?: com.ebookreader.app.domain.model.DownloadedBook(
                        bookId = bookId,
                        localFilePath = "",
                        downloadStatus = com.ebookreader.app.domain.model.DownloadStatus.COMPLETED,
                        downloadProgress = 1f,
